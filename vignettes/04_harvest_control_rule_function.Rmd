...
A default `mp` object can be generated from the `setup_mse_options()` function. Default MP objects do not have an HCR element defined. HCR objects must be defined by the user and inserted into the `mp` object.
...
_NOTE: The interface for defining complex HCR functions and for defining additional management meta-rules is subject to change (06/21/2024)._
